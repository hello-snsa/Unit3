...
async function initialVideos(){
    ...
    try{
      // var res= await  fetch(`https://youtube.googleapis.com/youtube/v3/search?q=${query}&key=AIzaSyC28lWQiG6_Ow_FcKB7aNyUWgzfnHrkfIY&maxResults=20`)
      // var res= await  fetch(`https://youtube.googleapis.com/youtube/v3/videos?key=AIzaSyC28lWQiG6_Ow_FcKB7aNyUWgzfnHrkfIY&maxResults=20`)
      var res= await  fetch(`https://youtube.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&regionCode=es&key=AIzaSyC28lWQiG6_Ow_FcKB7aNyUWgzfnHrkfIY`)
      //&videoCategoryId=17
